...
SOURCE_SQL = """
  ...
  FROM GOSALESDW.DIST_PRODUCT_FORECAST_FACT
"""

# 2. 적재 테이블 이름
TARGET_TABLE = "dist_product_forecast_fact"
...
with DAG(
    dag_id='dag_oracle23ai_GOSALESDW_DIST_PRODUCT_FORECAST_FACT_20260219_214408',
