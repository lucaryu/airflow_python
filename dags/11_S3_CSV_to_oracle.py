...
with DAG(
    dag_id='11_s3_csv_to_oracle',
    default_args=default_args,
    schedule=None, # 수동 실행
    catchup=False,
    tags=['s3', 'oracle', 'csv', 'kkbox'],
    params={
        "target_table": Param("train_v2", type="string", description="Oracle 타겟 테이블명"),
        "key_prefix": Param("kkbox-churn-prediction-challenge/train_v2.csv/data/churn_comp_refresh/train_v2.csv", type="string", description="S3 파일 경로 탐색 규칙 (Prefix)"),
